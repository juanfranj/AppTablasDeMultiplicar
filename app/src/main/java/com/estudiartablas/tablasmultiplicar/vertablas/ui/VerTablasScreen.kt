package com.estudiartablas.tablasmultiplicar.vertablas.ui
...
@Composable
fun VerTablasScreen(
    verTablasViewModel: VerTablasViewModel,
...
fun HeadVer(modifier: Modifier, navigationController: NavHostController) {
    ...
    Card(
        ...
        Row {
            Text(
                text = stringResource(R.string.ver_name),
                fontSize = 32.sp,
...
fun ItemVerTabla(num: String, navigationController: NavHostController) {
    Button(
        onClick = { navigationController.navigate(Routes.VerTablasSeleccion.createTabla(num.toInt())) },
